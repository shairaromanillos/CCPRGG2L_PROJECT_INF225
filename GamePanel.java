...
public class GamePanel extends JPanel implements Runnable {
    ...
    public void draw(Graphics g) {
        ...
        // I forgot to add this line of code in the video, it helps with the
    ...
    public void checkCollision() {
        ...
        if (ball.x <= 0) {
            ...
            newPaddles();
            newBall();
            System.out.println("Participant 2: " + score.player2);
            gameOver(); 
            // added to end game once player2 reaches the winning score
        }
        if (ball.x >= GAME_WIDTH - BALL_DIAMETER) {
            score.player1++;
            newPaddles();
            newBall();
            System.out.println("Participant 1: " + score.player1);
            gameOver(); 
            // added to end game once player1 reaches the winning score
        }
    }
